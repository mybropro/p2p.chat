        ...
        <div className="row">
          <div className="four columns">
            <div className="feature">
              ...
              <div className="feature-text">
                Choose a human-readable room name, such as the purpose of the
                meeting.
              </div>
            </div>
          </div>
          <div className="four columns">
            <div className="feature">
              ...
              <Send size={35} />
              <div className="feature-text">
                Send the link to your guests via email, chat, or any other
                means.
              </div>
            </div>
          </div>
          <div className="four columns">
            <div className="feature">
              ...
              <Video size={35} />
              <div className="feature-text">
                Chat to your guests over a secure, encrypted, peer-to-peer
                connection.
              </div>
            </div>
          </div>
